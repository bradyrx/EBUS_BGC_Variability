...
OUTPUT_DIR=/glade/scratch/rbrady/EBUS_BGC_Variability/${VAR}100m_monthly
LAYER=9 # Fortran-indexed depth layer to extract (if singular)
DEPTH_VAR=z_t
mkdir -p ${OUTPUT_DIR}

# Loop is for known BGC output. This is used because known ensemble members are split up differently.
for n in {022,023,024,025,026,027,028,029,030,031,032,033,034,035,101,102,103,104,105}
do
    ...
    then
        ...
        ncks -d time,841, -d ${DEPTH_VAR},0,${LAYER} ${temp_file} ${OUTPUT_DIR}/b.e11.B20TRC5CNBDRD.f09_g16.${n}.pop.h.${VAR}.192001-200512.nc
	...
	ncks -d ${DEPTH_VAR},0,${LAYER} ${temp_file} ${OUTPUT_DIR}/b.e11.B20TRC5CNBDRD.f09_g16.${n}.pop.h.${VAR}.192001-200512.nc
	histFile=${OUTPUT_DIR}/b.e11.B20TRC5CNBDRD.f09_g16.${n}.pop.h.${VAR}.192001-200512.nc
    fi
	...
	ncks -d ${DEPTH_VAR},0,${LAYER} ${temp_file} ${OUTPUT_DIR}/b.e11.BRCP85C5CNBDRD.f09_g16.${n}.pop.h.${VAR}.200601-210012.nc
	...
	ncks -d ${DEPTH_VAR},0,${LAYER} ${temp1} ${OUTPUT_DIR}/b.e11.BRCP85C5CNBDRD.f09_g16.${n}.pop.h.${VAR}.200601-208012.nc
	...
	ncks -d ${DEPTH_VAR},0,${LAYER} ${temp2} ${OUTPUT_DIR}/b.e11.BRCP85C5CNBDRD.f09_g16.${n}.pop.h.${VAR}.208101-210012.nc
