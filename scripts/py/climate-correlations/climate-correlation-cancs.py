...
def main():
    fileDir = '/glade/p/work/rbrady/EBUS_BGC_Variability/FG_CO2/CanCS/'
    ...
    ds = ds.where(ds['TLAT'] >= 12).where(ds['TLAT'] <= 22)
    ...
    df_enso.to_csv('smoothed_fgco2_vs_enso_cancs')
    df_pdo.to_csv('smoothed_fgco2_vs_pdo_cancs')
    df_amo.to_csv('smoothed_fgco2_vs_amo_cancs')
    df_nao.to_csv('smoothed_fgco2_vs_nao_cancs')
    df_sam.to_csv('smoothed_fgco2_vs_sam_cancs')
